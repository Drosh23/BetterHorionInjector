	...
	public partial class Form1 : MetroSetForm
	{
		...
		private void metroSetButton_0_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				webClient.Headers.Add(HttpRequestHeader.UserAgent, "BetterHorion");
				webClient.Proxy = null;
				this.metroSetLabel_1.Text = "Retrieving...";
				this.metroSetLabel_1.Refresh();
				this.metroSetProgressBar_0.Value = 10;

				string text2 = webClient.DownloadString("https://github.com/drosh23/betterhorion-releases/releases/latest/download/BetterHorion.client.dll"), "BetterHorion.client.dll"); ;
				...
				text = Path.Combine(Path.GetTempPath(), "BetterHorion.dll");
				Application.DoEvents();
						...
						else
						{
							...
							if (!(intPtr3 == IntPtr.Zero))
							{
								...
								IL_32C:
									...
									{
										return "Injected! Will Take Some Time To Appear";
									}
		...
		private void metroSetButton_2_Click(object sender, EventArgs e)
		{
			using (OpenFileDialog openFileDialog = new OpenFileDialog())
			{
				...
				if (openFileDialog.ShowDialog() == DialogResult.OK)
				{
					...
					{
						this.metroSetLabel_1.Text = "32-Bit is not supported yet !";
						this.metroSetButton_1.Enabled = false;
					}
				}
			}
		...
		public void metroSetButton_1_Click(object sender, EventArgs e)
		{
			((MetroSetButton)sender).Enabled = false;
			this.metroSetLabel_1.Text = "Injected!";

			WebClient Client = new WebClient();
				Client.DownloadFileCompleted += Client_DownloadFileCompleted;
				Client.DownloadProgressChanged += Client_DownloadProgressChanged;
			Client.DownloadFileAsync(new Uri("https://github.com/drosh23/betterhorion-releases/releases/latest/download/BetterHorion.client.dll"), "BetterHorion.client.dll");
			...
			{
			Memory.InjectDLL(Directory.GetCurrentDirectory().ToString() + "/BetterHorion.client.dll");
        ...
        private readonly object openFileDialog;
        ...
        public string BetterHorionDLL { get; private set; }
        ...
        private void metroSetLabel_2_Click(object sender, EventArgs e)
        {

        }

        private void metroSetLabel_9_Click(object sender, EventArgs e)
        {

        }

        private void metroSetLabel_1_Click_1(object sender, EventArgs e)
        {
        ...
        private void metroSetTabControl_0_SelectedIndexChanged_1(object sender, EventArgs e)
        {

        }

        private void metroSetTabPage_0_Click_1(object sender, EventArgs e)
        {

        }

        private void downloadProgress_Click(object sender)
        {

        }

        private void metroSetProgressBar_2_ValueChanged(object sender)
        {
